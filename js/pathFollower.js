function normalizeMesh(mesh, s) {
    var box = new THREE.Box3().setFromObject(mesh);
    var size = box.getSize();

    if(typeof(s) === "undefined"){
        // guess scale parameter
        s = 1.0 / Math.min(size.x, size.y, size.z);
    }
...
var PathFollower = function (obj, r0, rs) {
    ...
    var self = this;
    this.i = 0; //current interpolation index
    this.n = 480; // number of interpolation frames
    [this.x, this.q] = this.createPath(this.n, 20, r0, rs, 8);
    this.car = null;
    ...
    loader.load(obj, function (collada) {
        ...
        avatar.quaternion.setFromUnitVectors(x, y);
